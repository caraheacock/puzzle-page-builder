...
if ($puzzle_page_builder->has_icon_library()) {
...
function ppb_admin_init_icon_library() {
    add_meta_box('puzzle_icon_library', 'Icon Library', 'ppb_meta_options_icon_library', 'page', 'normal', 'low');
}

function ppb_meta_options_icon_library() {
    $puzzle_page_builder = new PuzzlePageBuilder;
    $puzzle_custom_icon_libraries_before = $puzzle_page_builder->custom_icon_libraries_before();
    $puzzle_custom_icon_libraries_after = $puzzle_page_builder->custom_icon_libraries_after();
    ?>
    <div class="puzzle-icon-library puzzle-pop-up-area">
        <div class="puzzle-icon-library-inner">
            ...
            if ($puzzle_custom_icon_libraries_before) {
                foreach ($puzzle_custom_icon_libraries_before as $library) {
                    $libraries[] = $library;
                }
            }
            
            if ($puzzle_page_builder->has_font_awesome_library()) {
                $libraries[] = array(
                    'name'          => 'Font Awesome',
                    'example_icon'  => 'image',
                    'icon_class'    => 'fa',
                    'icon_prefix'   => 'fa-',
                    'icons'         => ppb_font_awesome_icons()
                );
            }
            
            if ($puzzle_custom_icon_libraries_after) {
                foreach ($puzzle_custom_icon_libraries_after as $library) {
                    $libraries[] = $library;
                }
            }
            ?>
            
            <?php if ($puzzle_page_builder->has_icon_library_choice_none()) : ?>
            <hr />
            ...
            <?php foreach ($libraries as $library) : ?>
                ...
                <?php echo ppb_icon_library($library); ?>
            <?php endforeach; ?>
        </div>
